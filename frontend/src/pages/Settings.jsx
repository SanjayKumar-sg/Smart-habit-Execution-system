  ...
  return (
    <div className="fade-in" style={{ maxWidth: 700, margin: '0 auto' }}>
      <div style={{ marginBottom: '2rem' }}>
        ...
        <p className="text-muted">Customize your experience and global application settings.</p>
      </div>

      <form onSubmit={handleSave} style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
        
        <div className="card">
          <h3 className="h4" style={{ marginBottom: '1.5rem', borderBottom: '1px solid var(--border)', paddingBottom: '0.5rem' }}>Appearance & General</h3>
          <div className="grid-2">
            <div className="form-group">
              ...
              <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                ...
                }}>Toggle Global Theme</button>
              </div>
            </div>
            <div className="form-group">
              <label className="form-label">Language</label>
              <select name="language" className="form-input form-select" value={prefs.language} onChange={handleChange}>
        ...
        <div className="card">
          <h3 className="h4" style={{ marginBottom: '1.5rem', borderBottom: '1px solid var(--border)', paddingBottom: '0.5rem' }}>Notifications</h3>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <label style={{ display: 'flex', alignItems: 'center', gap: '1rem', cursor: 'pointer' }}>
              ...
              <div>
                ...
                <div className="text-xs text-muted">Receive alerts for scheduled habits</div>
              </div>
            </label>
            <label style={{ display: 'flex', alignItems: 'center', gap: '1rem', cursor: 'pointer' }}>
